...
public class Exercicio6 {
    ...
    public static void main(String[] args){
        try{
            ...
            //Aqui pegamos a Pos-Order sem espaços e passamos para o Array
            in = sc.nextLine();

            //Convertendo Input para Inteiros
            for(int i = 0; i < sizeInputLine; i++){
                InputPre[i] = Integer.parseInt(Character.toString(pre.charAt(i)));
                System.out.println(InputPre[i]);
                InputIn[i]  = Integer.parseInt(Character.toString(in.charAt(i)));
            }
